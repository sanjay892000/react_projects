      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="md:flex md:items-center md:gap-12">
            <NavLink to="/" className="block text-rose-500">
          ...
          <div className="flex items-center gap-6">
            <div className="sm:flex sm:gap-7 cursor-pointer" onClick={changeMode}>
              {theme == 'dark' ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
