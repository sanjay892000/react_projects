        ...
        <div className="relative z-10 max-w-screen-xl px-4  pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
          <div className="max-w-xl sm:mt-1 mt-80 space-y-8 text-center sm:text-right sm:ml-auto">
            <h2 className="text-4xl font-bold sm:text-5xl dark:text-white">
              Download Now
              <span className="hidden sm:block text-4xl dark:text-white">Prabhat App</span>
            </h2>

            <Link
              className="inline-flex text-white items-center px-6 dark:text-white py-3 font-medium bg-orange-700 rounded-lg hover:opacity-75"
              to="/"
            >
              <svg
                fill="white"
