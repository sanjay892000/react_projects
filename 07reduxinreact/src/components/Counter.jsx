  ...
  return (
    <div className="bg-gray-800">
      ...
      <div className="flex justify-evenly">
        <button type="button" className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 outline-none" onClick={() => dispatch(depositMoney(Number(myamount)))}>Deposit</button>
        <button type="button" className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 outline-none" onClick={() => dispatch(withdrawMoney(Number(myamount)))}>Withdraw</button>
      </div>
    </div>
  )
}
